...
The validated backend revision is `d34fd21`. Runtime credentials are held only by Render and Cloudflare; the browser receives neither the BFF secret nor database credentials.
